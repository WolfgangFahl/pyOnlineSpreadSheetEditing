...
class SpreadSheetView():
    ...
    def setup_ui(self):
        ...
        with ui.row() as self.input_row:
            ...
            ui.input(value=self.url,placeholder=f"Enter new {url_label_text}",on_change=self.on_change_url)
    ...
    async def reload(self):
        ...
        try:
            ...
            self.log_view.content=f"{link}<br>{self.lang} {self.endpoint} {self.sheetNames}"
