...
class GoogleSheetWikidataImport(App):
    ...
    def __init__(self, version):
        ...
        self.addMenuLink(
            text="docs",
            icon="file-document",
            href="https://wiki.bitplan.com/index.php/PyOnlineSpreadSheetEditing",
        )
        self.addMenuLink(
            text="github",
            icon="github",
            href="https://github.com/WolfgangFahl/pyOnlineSpreadSheetEditing",
        )
    ...
    def load_items_from_selected_sheet(self) -> typing.List[dict]:
        ...
        """
        self.wbQueries = WikibaseQuery.ofGoogleSheet(
    ...
    def setup(self):
        ...
        # select for sheets
        self.sheetSelect = jp.Select(
            classes=selectorClasses,
            a=self.header,
            value=self.sheetName,
...
"""
        ...
        self.urlInput = jp.Input(
            a=self.url_div,
            placeholder=f"Enter new {urlLabelText}",
            size=80,
